...
This is a complete reference to Galah's outward facing API. For a copy of the
reStructuredText that this documentation was generated from, go to the repo
`here <https://www.github.com/brownhead/galah>`_.
